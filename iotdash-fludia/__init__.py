...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if 'mtagid' in enrichments:
        if enrichments['mtagid'] == "11":
            bucket = os.environ['MTAG11_BUCKET']
            token = os.environ['MTAG11_WRITER']
            meas = "testa"
        elif enrichments['mtagid'] == "12":
            bucket = os.environ['MTAG12_BUCKET']
            token = os.environ['MTAG12_WRITER']
            meas = "testb"
        else:
            meas = "nomtag"
    else:
